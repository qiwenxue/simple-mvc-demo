...
function strEncodeDefault( data ) {
  return strEncode(data,mustKey,null,null);
}  

function strDecodeDefault( data ) {
  return strDecode(data,mustKey,null,null);
}
...
var mustKey = "_FGH$#496HJKKL@345_";
/*end*/