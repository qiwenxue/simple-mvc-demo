 ...
 */
public class DES {
  public static final String key = "_FGH$#496HJKKL@345_";
  	
  public static String ecodeDefault( String data ) {
    return  strEncode(data, key, null, null);
  }
  
  public static String decodeDefault( String data ) {
    return strDecode(data, key, null, null);
  }
  
	public static String encodeOneKey( String data, String firstKey ) {
	  return strEncode(data, firstKey, null, null);
	}
	
	public static String encode2Key( String data, String firstKey, String secondKey) {
	  return strEncode(data, firstKey, secondKey, null);
	}
	
	public static String encode3Key( String data, String firstKey, String secondKey, String thirdKey){
	  return strEncode(data, firstKey, secondKey, thirdKey);
	}
  ...
  public static String strEncode(String data, String firstKey, String secondKey, String thirdKey) {
	 ...
	 * @return
	 */
	public static String decodeOneKey( String data, String firstKey ) {
	  return strDecode(data, firstKey, null, null) ;
	}
	
	public static String decode2Key( String data, String firstKey, String secondKey ) {
	    return strDecode(data, firstKey, secondKey, null) ;
	}
	
	public static String decode3Key( String data, String firstKey, String secondKey, String thirdKey ) {
     return strDecode(data, firstKey, secondKey, thirdKey) ;
  }
